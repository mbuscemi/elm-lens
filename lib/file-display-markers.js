...
export default class FileDisplayMarkers {
    ...
    generateDecorationOptions(
        ...
        if (isOfTypeProgram) {
            ...
            teaEntrypointTextSpan.innerHTML = "Elm Application Entrypoint";
            ...
            if (projectIsProcessed && !fileIsReprocessing && isExposed && numExternalRefs == 0) {
