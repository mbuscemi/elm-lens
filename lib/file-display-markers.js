...
export default class FileDisplayMarkers {
    ...
    generate(expression, batch) {
        ...
        const decorationOptions = this.generateDecorationOptions(expression.isExposed, expression.numInternalRefs, batch);
   ...
   generateDecorationOptions(isExposed, numInternalRefs, batch) {
       ...
       externalRefSpan.innerHTML = " external references";
