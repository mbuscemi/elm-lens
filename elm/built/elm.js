...
var _user$project$Model_AST$parseFile = F3(
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				fileASTs: A3(
					_elm_lang$core$Dict$insert,
					fileName,
					_user$project$Model_AST$process(fileText),
					model.fileASTs)
			});
	});
...
var _user$project$Parsing$singleUpperCaseLetter = A2(
	_elm_tools$parser$Parser$keep,
	_elm_tools$parser$Parser$Exactly(1),
...
var _user$project$Parsing$spaces = A2(_elm_tools$parser$Parser$keep, _elm_tools$parser$Parser$zeroOrMore, _user$project$Parsing$isSpace);
var _user$project$Parsing$keywords = _elm_lang$core$Set$fromList(
	{
		ctor: '::',
		_0: 'let',
		_1: {
...
var _user$project$Parsing$isVarChar = function ($char) {
...
var _user$project$Parsing$upperCaseVariable = A3(_elm_tools$parser$Parser_LanguageKit$variable, _elm_lang$core$Char$isUpper, _user$project$Parsing$isVarChar, _user$project$Parsing$keywords);
var _user$project$Parsing$lowerCaseVariable = A3(_elm_tools$parser$Parser_LanguageKit$variable, _elm_lang$core$Char$isLower, _user$project$Parsing$isVarChar, _user$project$Parsing$keywords);
...
var _user$project$Parsing$takeLowerInitialSingleString = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(
...
var _user$project$Model_AllFunctions$parseFunctionLines = F3(
	function (fileName, lines, allFunctionLines) {
		return function (functionLines) {
			...
			_elm_lang$core$Tuple$first(
				A3(
					...
					{ctor: '_Tuple2', _0: _elm_lang$core$Dict$empty, _1: -1},
					lines)));
	});
var _user$project$Model_AllFunctions$record = F3(
	function (fileName, lines, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _user$project$Model_ExposedFunctions$moduleDeclaration = _elm_tools$parser$Parser$oneOf(
	{
		ctor: '::',
		_0: _elm_tools$parser$Parser$keyword('port module'),
		_1: {
			ctor: '::',
			_0: _elm_tools$parser$Parser$keyword('module'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Model_ExposedFunctions$exposedFunctions = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
...
var _user$project$Model_ExposedFunctions$parseExposedFunctions = F3(
	function (fileName, lines, exposedFuntions) {
		return function (functions) {
			...
			A2(
				...
				A2(
					...
					_user$project$Model_ExposedFunctions$exposedFunctions,
					A2(_elm_lang$core$String$join, '', lines))));
	});
var _user$project$Model_ExposedFunctions$record = F3(
	function (fileName, lines, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				exposedFunctions: A3(_user$project$Model_ExposedFunctions$parseExposedFunctions, fileName, lines, model.exposedFunctions)
			});
	});
...
var _user$project$ReferenceMetaData$Data = function (a) {
	return {instances: a};
};
var _user$project$ReferenceMetaData$ReferenceMetaData = function (a) {
	return {ctor: 'ReferenceMetaData', _0: a};
};
var _user$project$ReferenceMetaData$empty = _user$project$ReferenceMetaData$ReferenceMetaData(
	{
		instances: {ctor: '[]'}
	});
	...
	function (fileName, functionName, model) {
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$withDefault,
				_elm_lang$core$Set$empty,
				A2(_elm_lang$core$Dict$get, fileName, model.exposedFunctions)));
	});
var _user$project$Model_Report$lineForFunctionName = F3(
	function (fileName, functionName, model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			-1,
...
var _user$project$Text$spacesThenComment = _elm_tools$parser$Parser$oneOf(
	{
		...
		_0: A2(
			...
			A2(
				_elm_tools$parser$Parser_ops['|.'],
				_elm_tools$parser$Parser$succeed(true),
				_user$project$Parsing$spaces),
			_elm_tools$parser$Parser$keyword('--')),
		_1: {
			ctor: '::',
			_0: _elm_tools$parser$Parser$succeed(false),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Text$isComment = function (line) {
	return A2(
		_elm_lang$core$Result$withDefault,
		false,
		A2(_elm_tools$parser$Parser$run, _user$project$Text$spacesThenComment, line));
};
var _user$project$Text$blankOutCommentLines = function (textLines) {
	return A2(
		_elm_lang$core$List$map,
		function (line) {
			return _user$project$Text$isComment(line) ? '' : line;
		},
		textLines);
};
var _user$project$Text$splitOnNewLine = function (text) {
	return A2(_elm_lang$core$String$split, '\n', text);
};
var _user$project$Text$preprocess = function (text) {
	return _user$project$Text$blankOutCommentLines(
		_user$project$Text$splitOnNewLine(text));
};
...
var _user$project$Main$update = F2(
	function (message, model) {
		...
		var _p2 = _p0._0._1;
		var _p1 = _p0._0._0;
		var lines = _user$project$Text$preprocess(_p2);
		return A2(
			_user$project$Main$andSendReport,
			_p1,
			A3(
				_user$project$Model_InternalReferences$record,
				_p1,
				_p2,
				A3(
					_user$project$Model_AllFunctions$record,
					_p1,
					lines,
					A3(
						_user$project$Model_ExposedFunctions$record,
						_p1,
						lines,
						A3(_user$project$Model_AST$parseFile, _p1, _p2, model)))));
	});
var _user$project$Main$process = _elm_lang$core$Native_Platform.incomingPort(
	'process',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (x0) {
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$process(_user$project$Main$ProcessLines),
			_1: {ctor: '[]'}
		});
};
